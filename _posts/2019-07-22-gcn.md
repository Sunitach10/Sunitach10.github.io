...
In this way, features become increasingly more abstract at each consecutive layer.Where, W<sup>(l)</sup> is a weight matrix for the Lth neural network layer and σ(⋅)  is a non-linear activation function like the ReLU. 
